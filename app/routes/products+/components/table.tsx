...
import {Paper, Table, TableBody, TableContainer, useMediaQuery, useTheme} from '@mui/material';
...
import MobileView from '~/routes/products+/components/mobile-view';
...
export const ProductsTable = ({data, isLoading}: {data?: ApiProduct[]; isLoading: boolean}) => {
  ...
  if (isMobile) {
    return <MobileView products={data} doDeleteItem={doDeleteItem} />;
  }
